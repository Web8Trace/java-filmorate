...
INSERT INTO MPAS(mpa_name, mpa_description) VALUES ( 'PG-13','детям до 13 лет просмотр запрещен' ) ON CONFLICT DO NOTHING;
INSERT INTO MPAS(mpa_name, mpa_description) VALUES ( 'R','лицам до 17 лет просматривать фильм можно только со взрослыми' ) ON CONFLICT DO NOTHING;
